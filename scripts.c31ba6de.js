...
},{"object-assign":31,"fbjs/lib/invariant":28,"fbjs/lib/emptyObject":29,"fbjs/lib/emptyFunction":30}],12:[function(require,module,exports) {
'use strict';
...
},{"./cjs/react.production.min.js":20}],32:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./isNode":43}],35:[function(require,module,exports) {
'use strict';
...
},{"./isTextNode":42}],19:[function(require,module,exports) {
/** @license React v16.3.2
...
},{"fbjs/lib/invariant":28,"react":12,"fbjs/lib/ExecutionEnvironment":32,"object-assign":31,"fbjs/lib/emptyFunction":30,"fbjs/lib/getActiveElement":33,"fbjs/lib/shallowEqual":34,"fbjs/lib/containsNode":35,"fbjs/lib/emptyObject":29}],11:[function(require,module,exports) {
'use strict';
...
},{"./cjs/react-dom.production.min.js":19}],10:[function(require,module,exports) {
'use strict';
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'svg',
            { className: 'icon', 'aria-hidden': 'true', onClick: this.logoAnime },
            _react2.default.createElement('use', { xlinkHref: '#icon-landilogo1' })
          )
        ),
        _react2.default.createElement(
          'div',
          { className: 'spacer border-bottom-1px' },
          _react2.default.createElement(
            'div',
            { className: 'title' },
            _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            function (_ref) {
              ...
              return menu ? _react2.default.createElement(
                'div',
                { className: 'nav__bar has-animation animation-rtl animate-in' },
                _react2.default.createElement(
                  'div',
                  { className: 'parle' },
                  'position'
...
},{"react":12,"./context.js":10,"./Header.styl":23,"animejs":27}],25:[function(require,module,exports) {
'use strict';
...
var ScreenBar = function (_React$Component) {
  ...
  _createClass(ScreenBar, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'nav',
        { className: 'screen__bar border-right-1px' },
        _react2.default.createElement(
          _context.Consumer,
          null,
          function (_ref) {
            ...
            return docs.map(function (doc) {
              return _react2.default.createElement('button', {
                ...
                className: 'screen__doc ' + (doc === screen && 'active') });
            });
          }
        )
      );
...
},{"react":12,"../context.js":10,"./ScreenBar.styl":23}],26:[function(require,module,exports) {
'use strict';
...
var pages = [function (_ref) {
  ...
  return _react2.default.createElement(
    'section',
    { className: 'screen__one' },
    _react2.default.createElement(
      'div',
      null,
      _react2.default.createElement(
        'div',
        { className: 'parle page__transition ' + (!pageTransition && 'animation-ltr') },
        'Better Teaching'
      ),
      _react2.default.createElement(
        'div',
        { className: 'parle page__transition ' + (!pageTransition && 'animation-rtl') },
        'with Peer Learning'
      )
    )
  );
  ...
  return _react2.default.createElement(
    'section',
    { className: 'screen__two' },
    _react2.default.createElement('div', { className: 'doctor' }),
    _react2.default.createElement(
      'div',
      { className: 'describe' },
      _react2.default.createElement(
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        function (_ref3) {
          ...
          return _react2.default.createElement(
            'section',
            { className: 'screen__content page__transition ' + (pageTransition && 'animation-ttb') },
...
},{"react":12,"./ScreenContent.styl":23,"../context.js":10}],9:[function(require,module,exports) {
'use strict';
  ...
  _createClass(Content, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'section',
        { className: 'screens' },
        _react2.default.createElement(_ScreenBar2.default, null),
        _react2.default.createElement(_ScreenContent2.default, null)
      );
    }
  }]);
...
},{"react":12,"./content/ScreenBar.js":25,"./content/ScreenContent.js":26,"./Content.styl":23}],4:[function(require,module,exports) {
'use strict';
...
},{"react":12,"react-dom":11,"./home/Header.js":8,"./home/Content.js":9,"./home/context.js":10,"normalize.css":23,"../styles/index.styl":23,"./index.styl":23}]},{},[4], null)
//# sourceMappingURL=/scripts.14c7a7ee.map